...
<h4 class="modal-title text-center">Handbag</h4>
  </div>
...
<img src="images/Handbag.jpg" alt="Handbag" class="details img-responsive"/>
</div>
</div>
<div class="col-sm-6">
  <h4>Details</h4>
  <p>These Handbags are amazing.You should try them and buy. Get them while they last.</p>
  <hr/>
  <p>Price: $12.99</p>
  <p>Brand: Handbag</p>
